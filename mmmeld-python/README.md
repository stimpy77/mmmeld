# ⚠️ DEPRECATED - Python Implementation

**This Python implementation of mmmeld is deprecated and no longer actively maintained.**

The project has been reimplemented in Go for better performance, easier distribution, and improved maintainability.

**Please use the Go implementation located in the `mmmeld-go/` directory for all new projects.**

This Python version is preserved for historical reference and for users who may still depend on it, but no new features or bug fixes will be added.

---

# Original `mmmeld` - Multimedia Meld - Audio/Image Video Generator
