...
def generate_video(image_inputs, audio_path, bg_music_path, output_path, bg_music_volume, start_margin, end_margin, temp_folder):
    ...
    if audio_path:
        ...
        # Use a large number for loop count instead of loop=-1:size=
        filter_complex.append(f"[0:v]loop=loop=999999:size=1:start=0,setpts=N/FRAME_RATE/TB[looped_video];")
